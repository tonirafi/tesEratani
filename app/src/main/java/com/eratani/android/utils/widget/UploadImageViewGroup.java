package com.eratani.android.utils.widget;
...
import com.eratani.android.adapter.PhotoCardAdapter;
import com.eratani.android.adapter.card.UploadImageUnitCard;
import com.eratani.android.adapter.providers.UploadImageUnitCardProvider;
import com.eratani.android.configapp.router.IntentUtil;
import com.eratani.android.utils.upload.ImageUploadManager;
import com.eratani.android.utils.upload.image.bean.ImageBean;
import com.eratani.android.utils.view.GridSpacingItemDecoration;
...
public class UploadImageViewGroup extends LinearLayout implements UploadImageUnitCardProvider.UploadImageUnitImageListener {
    ...
    public static class InnerGridLayoutManager extends GridLayoutManager {
        ...
        public InnerGridLayoutManager(Context context, int spanCount,Boolean canScrollVertically) {
            super(context, spanCount);
